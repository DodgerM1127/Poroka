  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="max-w-3xl mx-auto px-6 py-12 text-center">
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">Najin dan ne bo isti brez tebe. Da bova lažje pripravila vse potrebno, nama prosim pomagaj in se čimprej označi, če prideš, najkasneje pa do 29. 6. Se vidimo kmalu!</p>
      </section>
      ...
      <section id="faq" className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="space-y-4">
          ...
          <details className="bg-gray-100 p-4 rounded">
            ...
            <p className="mt-2 text-gray-600">Najbolj pomembno nama je, da se dobro počutiš. Verjetno boš v drugih barvah precej izstopal. Pa precej bolj zabavno je, če vse goste nekaj povezuje.</p>
          </details>
          <details className="bg-gray-100 p-4 rounded">
