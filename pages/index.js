  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-2 gap-6 items-start">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="text-lg text-white"><a href="https://maps.app.goo.gl/zs4uZ6e131SyBoVd6" className="underline text-white" target="_blank">Mladinski center Rakovnik</a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="dresscode" className="max-w-6xl mx-auto px-6 py-16">
        <div>
          ...
          <div className="text-gray-600 text-lg leading-relaxed mb-4 space-y-2">
            ...
            <p className="text-gray-600 text-lg leading-relaxed text-center">Barve v pastelih. Najbolj boste zablesteli v kakšnih nežnih, pastelnih odtenkih. Če se le da, se poskusite izogniti beli (ta je tokrat rezervirana za nevesto), črni in rdeči.</p>
          </div>
        </div>
      </section>
      ...
      <section id="help" className="max-w-6xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-600 text-lg leading-relaxed text-center mt-4">Če neveš kam prinesti dobrote, si oglej <a href="https://drive.google.com/file/d/1Y_fMvqrrtySFLOCO-Y1OkrgzKpc8NBje/view?usp=sharing" target="_blank" rel="noreferrer" className="text-[#b17253] hover:underline">ta video</a>.</p>
      </section>
      ...
      <section id="faq" className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="space-y-4">
          <details className="bg-gray-100 p-4 rounded">
            ...
            <p className="mt-2 text-gray-600">Do 29. 6. Najbolje pa je, da takoj označiš.</p>
          </details>
          <details className="bg-gray-100 p-4 rounded">
            ...
            <p className="mt-2 text-gray-600">Enostavno še enkrat izpolni obrazec. Če pa bi si po 29. 6. premislil, nama to prosim sporoči na 064 140 471 (Gaja) ali 070 798 388 (Matej).</p>
          </details>
          <details className="bg-gray-100 p-4 rounded">
            <summary className="cursor-pointer font-semibold text-gray-800">Ali je zelo narobe, če se ne držim dresscoda?</summary>
            <p className="mt-2 text-gray-600">Najpomembnejše nama je, da se dobro počutiš. Verjetno boš v drugih barvah precej izstopal, pa tudi precej bolj zabavno je, če vse goste nekaj povezuje.</p>
          </details>
        </div>
      </section>
